...
2 Point Tasks: <u>Wyatt Completed 9/12<u>
...
1 Point Tasks: <u>Aditi Completed 9/10<u>
...
2 Point Tasks: <u>Wyatt Completed 9/13<u>
...
1 Point Tasks: <u>Aditi Completed 9/11<u>
...
### Sad-Path Story 9: As a tester/developer, I want to receive clear error messages when entering invalid recipe data so that I can understand what needs to be corrected without needing prior knowledge
Tasks (ongoing): In Progress
